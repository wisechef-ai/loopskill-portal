...
const STATIC_ROUTES: { path: string; priority: string; changefreq: string }[] = [
  ...
  { path: '/docs/sync', priority: '0.7', changefreq: 'weekly' },
  { path: '/docs/mcp', priority: '0.7', changefreq: 'weekly' },
  { path: '/docs/bundles', priority: '0.7', changefreq: 'weekly' },
  { path: '/docs/client-deployment', priority: '0.7', changefreq: 'weekly' },
