...
This project is indexed by GitNexus as **recipes-portal** (36 symbols, 30 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
