...
This project is indexed by GitNexus as **recipes-portal** (43 symbols, 34 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
